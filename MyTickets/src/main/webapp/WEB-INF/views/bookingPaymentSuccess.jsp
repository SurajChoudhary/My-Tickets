			...
			<div class="span4">
				<c:if test="${!empty message}">
					<div class="alert alert-dismissable alert-success">
						...
						<strong>Congratulations!</strong><br> ${message}
					</div>
				</c:if>
			</div>
			<div class="span8">
				...
				<div class="well well-lg">
					...
					<p class="text-primary">Thank you for choosing MyTicket.com!</p>
					<br>
					<p class="text-primary">Enjoy your movie!</p>
					<br>
					<p class="text-success">Confirmation email sent at ${email}.</p>
					<br>
					<p class="text-primary">
						Or you can print your ticket <a class="btn btn-link"
							href="${pageContext.request.contextPath}/customer/printTicket">here</a>
					</p>
