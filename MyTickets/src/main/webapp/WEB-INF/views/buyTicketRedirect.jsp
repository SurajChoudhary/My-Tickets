...
<html>
<head>
<title>Buy Tickets | MyTickets.com</title>
		...
		<div class="row" >
			<div class="span4">
				<div class="well">
					...
					City : ${sessionScope.bookMovieForm.cityName}<br> Selected :
				...
				<div class="span8"  align="center"><br><br><br><br>
						...
						<fieldset>
							...
							<div class="form-group">
								<div class="col-lg-10 col-lg-offset-2">
									<button type="submit" value="confirm" class="btn btn-primary btn-sm">Select</button>
								</div>
							</div>
					...
					<form class="form-horizontal"
						action="${pageContext.request.contextPath}/confirmBooking"  align="left"
					method="post">
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label" for="timings">Select
									Show Timing</label>
									...
									<table class="table">
										<tbody>
											<c:forEach var="showtime" items="${showtimes}">
												<tr>
													<td><input type="radio" name="showtime"
														value="${showtime.showtimeId}">
														${showtime.showStartTime}</td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
